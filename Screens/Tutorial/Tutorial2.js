    ...
    return (
        <Grid>
            ...
            <Row size={50} style={[styles.centerContentX, styles.centerContentY, styles.showBorder]}>
                <Text style={[styles.question]}><Text style={{backgroundColor:"khaki"}}>Jadid</Text> : La partie du Coran qui est dans votre mémoire <Text style={{textDecorationLine:"underline"}}>à{"\u00a0"}court{"\u00a0"}terme</Text>{"\n\n"}
